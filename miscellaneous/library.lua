...
menu.bg.pre.Text = '<font color="rgb(255,0,0)">coca-cola</font>'

local library = {cheatname = "";ext = "";gamename = "";colorpicking = false;tabbuttons = {};tabs = {};options = {};flags = {};scrolling = false;notifyText = Drawing.new("Text");playing = false;multiZindex = 200;toInvis = {};libColor = Color3.fromRGB(255,0,0);disabledcolor = Color3.fromRGB(233, 0, 0);blacklisted = {Enum.KeyCode.W,Enum.KeyCode.A,Enum.KeyCode.S,Enum.KeyCode.D,Enum.UserInputType.MouseMovement}}
...
tabviewer.button.element.BackgroundColor3 = Color3.fromRGB(255,0,0)
menu.bg.bg.bg.bg.element.BackgroundColor3 = Color3.fromRGB(255, 0, 0)
menu.bg.bg.BackgroundColor3 = Color3.fromRGB(15,15,15)
menu.bg.bg.bg.bg.BackgroundColor3 = Color3.fromRGB(15,15,15)
tabholder.BackgroundColor3 = Color3.fromRGB(25, 25, 25)
menu.bg.bg.bg.bg.main.BackgroundColor3 = Color3.fromRGB(25, 25, 25)
...
function library:addTab(name)
    ...
    function tab:createGroup(pos,groupname) -- newTab[pos == 0 and "left" or "right"] 
        ...
        function group:addToggle(args)
            ...
            mid.Name = "mid"
            mid.Parent = tobble
            mid.BackgroundColor3 = Color3.fromRGB(255,0,0)
